...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.boutique.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.boutiques.update", [$boutique->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="nom">{{ trans('cruds.boutique.fields.nom') }}</label>
                <input class="form-control {{ $errors->has('nom') ? 'is-invalid' : '' }}" type="text" name="nom" id="nom" value="{{ old('nom', $boutique->nom) }}" required>
                @if($errors->has('nom'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" name="type" id="type" required>
                    ...
                    @foreach(App\Models\Boutique::TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('type', $boutique->type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('type'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('categorie') ? 'is-invalid' : '' }}" name="categorie_id" id="categorie_id" required>
                    @foreach($categories as $id => $entry)
                        <option value="{{ $id }}" {{ (old('categorie_id') ? old('categorie_id') : $boutique->categorie->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('ville') ? 'is-invalid' : '' }}" name="ville_id" id="ville_id" required>
                    @foreach($villes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('ville_id') ? old('ville_id') : $boutique->ville->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('ville'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $boutique->email) }}">
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telephone') ? 'is-invalid' : '' }}" type="text" name="telephone" id="telephone" value="{{ old('telephone', $boutique->telephone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image') ? 'is-invalid' : '' }}" type="text" name="image" id="image" value="{{ old('image', $boutique->image) }}">
                @if($errors->has('image'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('site_web') ? 'is-invalid' : '' }}" type="text" name="site_web" id="site_web" value="{{ old('site_web', $boutique->site_web) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facebook') ? 'is-invalid' : '' }}" type="text" name="facebook" id="facebook" value="{{ old('facebook', $boutique->facebook) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instagram') ? 'is-invalid' : '' }}" type="text" name="instagram" id="instagram" value="{{ old('instagram', $boutique->instagram) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tiktok') ? 'is-invalid' : '' }}" type="text" name="tiktok" id="tiktok" value="{{ old('tiktok', $boutique->tiktok) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('youtube') ? 'is-invalid' : '' }}" type="text" name="youtube" id="youtube" value="{{ old('youtube', $boutique->youtube) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('longitude') ? 'is-invalid' : '' }}" type="number" name="longitude" id="longitude" value="{{ old('longitude', $boutique->longitude) }}" step="0.0000000001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('latitude') ? 'is-invalid' : '' }}" type="number" name="latitude" id="latitude" value="{{ old('latitude', $boutique->latitude) }}" step="0.0000000001">
